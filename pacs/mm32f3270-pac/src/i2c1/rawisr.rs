...
pub struct R(crate::R<RAWISR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RAWISR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RAWISR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RAWISR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "RAW Interrupt Status Register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [rawisr](index.html) module"]
