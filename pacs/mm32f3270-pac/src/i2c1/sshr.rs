...
pub struct R(crate::R<SSHR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SSHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SSHR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SSHR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SSHR` writer"]
pub struct W(crate::W<SSHR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SSHR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SSHR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SSHR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, SSHR_SPEC, u16, u16, 16, O>;
impl R {
