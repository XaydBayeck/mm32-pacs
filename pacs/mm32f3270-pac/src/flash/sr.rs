...
pub type PGERR_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, SR_SPEC, bool, O>;
...
pub type WRPRTERR_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, SR_SPEC, bool, O>;
#[doc = "Field `EOP` reader - End of operation"]
pub type EOP_R = crate::BitReader<bool>;
#[doc = "Field `EOP` writer - End of operation"]
pub type EOP_W<'a, const O: u8> = crate::BitWriter1C<'a, u32, SR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 0 - Busy"]
    #[inline(always)]
...
impl crate::Writable for SR_SPEC {
    ...
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0x34;
}
