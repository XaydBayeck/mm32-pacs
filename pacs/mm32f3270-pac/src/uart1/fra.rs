...
pub struct R(crate::R<FRA_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<FRA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<FRA_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<FRA_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `FRA` writer"]
pub struct W(crate::W<FRA_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<FRA_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<FRA_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<FRA_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DIV_FRACTION_W<'a, const O: u8> = crate::FieldWriter<'a, u32, FRA_SPEC, u8, u8, 4, O>;
impl R {
