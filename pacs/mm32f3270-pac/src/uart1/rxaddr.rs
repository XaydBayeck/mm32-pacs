...
pub struct R(crate::R<RXADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<RXADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<RXADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<RXADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `RXADDR` writer"]
pub struct W(crate::W<RXADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<RXADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<RXADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<RXADDR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `RXADDR` reader - Synchronous frame match address"]
pub type RXADDR_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RXADDR` writer - Synchronous frame match address"]
pub type RXADDR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, RXADDR_SPEC, u8, u8, 8, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn rxaddr(&mut self) -> RXADDR_W<0> {
        RXADDR_W::new(self)
    }
