...
pub struct R(crate::R<TOCNTR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TOCNTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TOCNTR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TOCNTR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TOCNTR` writer"]
pub struct W(crate::W<TOCNTR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TOCNTR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TOCNTR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TOCNTR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CNT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TOCNTR_SPEC, u8, u8, 8, O>;
impl R {
