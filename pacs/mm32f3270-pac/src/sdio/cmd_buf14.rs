...
pub struct R(crate::R<CMD_BUF14_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CMD_BUF14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CMD_BUF14_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CMD_BUF14_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CMD_BUF14` writer"]
pub struct W(crate::W<CMD_BUF14_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CMD_BUF14_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CMD_BUF14_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CMD_BUF14_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DAT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CMD_BUF14_SPEC, u8, u8, 8, O>;
impl R {
