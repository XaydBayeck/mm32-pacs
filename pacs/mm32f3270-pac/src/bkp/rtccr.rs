...
pub type CAL_W<'a, const O: u8> = crate::FieldWriter<'a, u16, RTCCR_SPEC, u8, u8, 7, O>;
...
pub type CCO_W<'a, const O: u8> = crate::BitWriter<'a, u16, RTCCR_SPEC, bool, O>;
...
pub type ASOE_W<'a, const O: u8> = crate::BitWriter<'a, u16, RTCCR_SPEC, bool, O>;
...
pub type ASOS_W<'a, const O: u8> = crate::BitWriter<'a, u16, RTCCR_SPEC, bool, O>;
impl R {
