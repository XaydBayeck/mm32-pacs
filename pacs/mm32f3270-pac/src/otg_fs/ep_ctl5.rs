...
pub struct R(crate::R<EP_CTL5_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<EP_CTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<EP_CTL5_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<EP_CTL5_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `EP_CTL5` writer"]
pub struct W(crate::W<EP_CTL5_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<EP_CTL5_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<EP_CTL5_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<EP_CTL5_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EP_HSHK_5_R = crate::BitReader<bool>;
...
pub type HOST_WO_HUB_5_R = crate::BitReader<bool>;
...
pub type HOST_WO_HUB_5_W<'a, const O: u8> = crate::BitWriter<'a, u32, EP_CTL5_SPEC, bool, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ep_hshk_5(&mut self) -> EP_HSHK_5_W<0> {
        EP_HSHK_5_W::new(self)
    }
    #[doc = "Bit 1 - Any access to this endpoint will cause the otg_fs to return a stall handshake"]
    #[inline(always)]
    #[must_use]
    pub fn ep_stall_5(&mut self) -> EP_STALL_5_W<1> {
        EP_STALL_5_W::new(self)
    }
    #[doc = "Bit 2 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_tx_en_5(&mut self) -> EP_TX_EN_5_W<2> {
        EP_TX_EN_5_W::new(self)
    }
    #[doc = "Bit 3 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_rx_en_5(&mut self) -> EP_RX_EN_5_W<3> {
        EP_RX_EN_5_W::new(self)
    }
    #[doc = "Bit 4 - These three bits define whether the endpoint is enabled and the direction of the endpoint"]
    #[inline(always)]
    #[must_use]
    pub fn ep_ctl_dis_5(&mut self) -> EP_CTL_DIS_5_W<4> {
        EP_CTL_DIS_5_W::new(self)
    }
    #[doc = "Bit 6 - This is a bit for master mode only and exists only in the control register of endpoint 0"]
    #[inline(always)]
    #[must_use]
    pub fn retry_dis_5(&mut self) -> RETRY_DIS_5_W<6> {
        RETRY_DIS_5_W::new(self)
    }
    #[doc = "Bit 7 - This is a bit for master mode only and exists only in the control endpt0_rg register of endpoint 0."]
    #[inline(always)]
    #[must_use]
    pub fn host_wo_hub_5(&mut self) -> HOST_WO_HUB_5_W<7> {
        HOST_WO_HUB_5_W::new(self)
    }
