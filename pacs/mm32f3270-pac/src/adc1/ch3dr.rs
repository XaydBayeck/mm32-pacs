...
pub struct R(crate::R<CH3DR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH3DR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH3DR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH3DR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Channel 3 data register\n\nThis register you can [`read`](crate::generic::Reg::read). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch3dr](index.html) module"]
