...
pub struct R(crate::R<CCR4FALL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CCR4FALL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CCR4FALL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CCR4FALL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CCR4FALL` writer"]
pub struct W(crate::W<CCR4FALL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CCR4FALL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CCR4FALL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CCR4FALL_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CCR4FALL` reader - Capture/compare value for ch4 when counting down in PWM center-aligned mode"]
pub type CCR4FALL_R = crate::FieldReader<u16, u16>;
#[doc = "Field `CCR4FALL` writer - Capture/compare value for ch4 when counting down in PWM center-aligned mode"]
pub type CCR4FALL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CCR4FALL_SPEC, u16, u16, 16, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ccr4fall(&mut self) -> CCR4FALL_W<0> {
        CCR4FALL_W::new(self)
    }
