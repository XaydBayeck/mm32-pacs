...
pub type PLS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 4, O>;
#[doc = "Field `STAND_FS_WK` reader - Quickly wake up the Standby mode selection bit"]
pub type STAND_FS_WK_R = crate::FieldReader<u8, u8>;
#[doc = "Field `STAND_FS_WK` writer - Quickly wake up the Standby mode selection bit"]
pub type STAND_FS_WK_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CR_SPEC, u8, u8, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pls(&mut self) -> PLS_W<9> {
        PLS_W::new(self)
    }
    #[doc = "Bits 14:15 - Quickly wake up the Standby mode selection bit"]
    #[inline(always)]
    #[must_use]
    pub fn stand_fs_wk(&mut self) -> STAND_FS_WK_W<14> {
        STAND_FS_WK_W::new(self)
    }
