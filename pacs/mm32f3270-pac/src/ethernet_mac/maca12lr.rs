...
pub struct R(crate::R<MACA12LR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MACA12LR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MACA12LR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MACA12LR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MACA12LR` writer"]
pub struct W(crate::W<MACA12LR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MACA12LR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MACA12LR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MACA12LR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDL_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MACA12LR_SPEC, u32, u32, 32, O>;
impl R {
