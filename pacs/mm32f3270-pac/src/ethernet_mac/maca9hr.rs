...
pub struct R(crate::R<MACA9HR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MACA9HR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MACA9HR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MACA9HR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MACA9HR` writer"]
pub struct W(crate::W<MACA9HR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MACA9HR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MACA9HR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MACA9HR_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDH_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MACA9HR_SPEC, u16, u16, 16, O>;
...
pub type MBYTEC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MACA9HR_SPEC, u8, u8, 6, O>;
#[doc = "Field `SELE` reader - Source address"]
pub type SELE_R = crate::BitReader<bool>;
#[doc = "Field `SELE` writer - Source address"]
pub type SELE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MACA9HR_SPEC, bool, O>;
#[doc = "Field `ADDE` reader - Address enable"]
pub type ADDE_R = crate::BitReader<bool>;
#[doc = "Field `ADDE` writer - Address enable"]
pub type ADDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, MACA9HR_SPEC, bool, O>;
impl R {
