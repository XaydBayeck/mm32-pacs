...
pub type USBOTGFS_R = crate::BitReader<bool>;
#[doc = "Field `USBOTGFS` writer - *D7"]
pub type USBOTGFS_W<'a, const O: u8> = crate::BitWriter<'a, u32, AHB2RSTR_SPEC, bool, O>;
impl R {
    #[doc = "Bit 7 - *D7"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn usbotgfs(&mut self) -> USBOTGFS_W<7> {
        USBOTGFS_W::new(self)
    }
