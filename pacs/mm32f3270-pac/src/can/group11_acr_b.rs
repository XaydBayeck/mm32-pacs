...
pub struct R(crate::R<GROUP11_ACR_B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GROUP11_ACR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GROUP11_ACR_B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GROUP11_ACR_B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GROUP11_ACR_B` writer"]
pub struct W(crate::W<GROUP11_ACR_B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GROUP11_ACR_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GROUP11_ACR_B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GROUP11_ACR_B_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AC_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GROUP11_ACR_B_SPEC, u8, u8, 8, O>;
impl R {
