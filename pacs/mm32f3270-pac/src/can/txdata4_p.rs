...
pub struct R(crate::R<TXDATA4_P_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXDATA4_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXDATA4_P_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXDATA4_P_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXDATA4_P` writer"]
pub struct W(crate::W<TXDATA4_P_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXDATA4_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXDATA4_P_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXDATA4_P_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA4_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TXDATA4_P_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - DATA4"]
    #[inline(always)]
