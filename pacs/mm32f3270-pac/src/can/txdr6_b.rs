...
pub struct R(crate::R<TXDR6_B_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXDR6_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXDR6_B_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXDR6_B_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXDR6_B` writer"]
pub struct W(crate::W<TXDR6_B_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXDR6_B_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXDR6_B_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXDR6_B_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TXDR6` reader - Transmit data register"]
pub type TXDR6_R = crate::FieldReader<u32, u32>;
#[doc = "Field `TXDR6` writer - Transmit data register"]
pub type TXDR6_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TXDR6_B_SPEC, u32, u32, 32, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn txdr6(&mut self) -> TXDR6_W<0> {
        TXDR6_W::new(self)
    }
