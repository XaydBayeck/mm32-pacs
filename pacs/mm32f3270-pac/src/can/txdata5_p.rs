...
pub struct R(crate::R<TXDATA5_P_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<TXDATA5_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<TXDATA5_P_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<TXDATA5_P_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `TXDATA5_P` writer"]
pub struct W(crate::W<TXDATA5_P_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<TXDATA5_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<TXDATA5_P_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<TXDATA5_P_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type DATA5_W<'a, const O: u8> = crate::FieldWriter<'a, u32, TXDATA5_P_SPEC, u8, u8, 8, O>;
impl R {
    #[doc = "Bits 0:7 - DATA5"]
    #[inline(always)]
