...
pub struct R(crate::R<GROUP1_AMR2_P_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GROUP1_AMR2_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GROUP1_AMR2_P_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GROUP1_AMR2_P_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GROUP1_AMR2_P` writer"]
pub struct W(crate::W<GROUP1_AMR2_P_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GROUP1_AMR2_P_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GROUP1_AMR2_P_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GROUP1_AMR2_P_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AM_W<'a, const O: u8> = crate::FieldWriter<'a, u32, GROUP1_AMR2_P_SPEC, u8, u8, 8, O>;
impl R {
