...
pub type OK_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, bool, O>;
#[doc = "Field `WARN` writer - SYNC warning clear flag"]
pub type WARN_W<'a, const O: u8> = crate::BitWriter<'a, u32, ICR_SPEC, bool, O>;
