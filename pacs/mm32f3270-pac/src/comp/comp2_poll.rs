...
pub struct R(crate::R<COMP2_POLL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<COMP2_POLL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<COMP2_POLL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<COMP2_POLL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `COMP2_POLL` writer"]
pub struct W(crate::W<COMP2_POLL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<COMP2_POLL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<COMP2_POLL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<COMP2_POLL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type EN_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_POLL_SPEC, bool, O>;
...
pub type CH_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_POLL_SPEC, bool, O>;
...
pub type FIXN_W<'a, const O: u8> = crate::BitWriter<'a, u32, COMP2_POLL_SPEC, bool, O>;
...
pub type PERIOD_W<'a, const O: u8> = crate::FieldWriter<'a, u32, COMP2_POLL_SPEC, u8, u8, 3, O>;
