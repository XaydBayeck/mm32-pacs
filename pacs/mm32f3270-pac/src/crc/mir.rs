...
pub struct R(crate::R<MIR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<MIR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<MIR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `MIR` writer"]
pub struct W(crate::W<MIR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<MIR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<MIR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<MIR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `MIR` reader - Middle data register"]
pub type MIR_R = crate::FieldReader<u32, u32>;
#[doc = "Field `MIR` writer - Middle data register"]
pub type MIR_W<'a, const O: u8> = crate::FieldWriter<'a, u32, MIR_SPEC, u32, u32, 32, O>;
impl R {
